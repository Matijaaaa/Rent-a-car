...
CREATE TABLE Rezervacija_Dodatna_usluga (
...
INSERT INTO Zaposlenik (Ime, Prezime, Pozicija, Email, Telefon, Broj_telefona, Godine_staza, Datum_zapošljavanja)
VALUES 
('Luka', 'Perić', 'Menadžer', 'luka.peric@mail.com', '0911111111', '0912223333', 10, '2020-01-10'),
('Sara', 'Lukić', 'Agent', 'sara.lukic@mail.com', '0912222222', NULL, 3, '2021-03-20'),
('Toni', 'Barišić', 'Mehaničar', 'toni.barisic@mail.com', '0913333333', '0914445555', 5, '2021-05-15'),
('Nina', 'Kovač', 'Administrativni radnik', 'nina.kovac@mail.com', '0914444444', NULL, 2, '2022-02-10'),
('Ivan', 'Milić', 'Agent', 'ivan.milic@mail.com', '0915555555', '0916667777', 4, '2021-08-08'),
('Marija', 'Marković', 'Mehaničar', 'marija.markovic@mail.com', '0916666666', NULL, 6, '2022-04-22'),
('Petar', 'Lovrić', 'Agent', 'petar.lovric@mail.com', '0917777777', '0918889999', 1, '2023-01-05'),
('Ivana', 'Božić', 'Menadžer', 'ivana.bozic@mail.com', '0918888888', NULL, 8, '2020-05-01'),
('Ana', 'Vuković', 'Mehaničar', 'ana.vukovic@mail.com', '0919999999', '0910001111', 5, '2021-09-17'),
('Goran', 'Nikolić', 'Agent', 'goran.nikolic@mail.com', '0911111222', NULL, 2, '2022-12-25'),
('Martina', 'Tomić', 'Agent', 'martina.tomic@mail.com', '0912222111', '0913333222', 1, '2023-04-10'),
('Davor', 'Radić', 'Administrativni radnik', 'davor.radic@mail.com', '0913333222', NULL, 3, '2022-05-19'),
('Klara', 'Horvat', 'Agent', 'klara.horvat@mail.com', '0914444333', '0915555444', 4, '2021-07-07'),
('Maja', 'Kralj', 'Mehaničar', 'maja.kralj@mail.com', '0915555444', NULL, 2, '2023-02-02'),
('Josip', 'Kovačić', 'Administrativni radnik', 'josip.kovacic@mail.com', '0916666555', '0917777666', 3, '2022-09-09'),
('Nikolina', 'Matić', 'Agent', 'nikolina.matic@mail.com', '0917777666', NULL, 5, '2021-11-11'),
('Mateo', 'Filipović', 'Mehaničar', 'mateo.filipovic@mail.com', '0918888777', '0919999888', 7, '2020-03-15'),
('Marina', 'Jurić', 'Administrativni radnik', 'marina.juric@mail.com', '0919999888', NULL, 4, '2022-06-28'),
('Branko', 'Novak', 'Menadžer', 'branko.novak@mail.com', '0911111999', '0912222000', 9, '2020-11-11'),
('Katarina', 'Varga', 'Agent', 'katarina.varga@mail.com', '0912222000', NULL, 2, '2021-12-10'),
('Lana', 'Bogdanović', 'Mehaničar', 'lana.bogdanovic@mail.com', '0913333000', '0914444000', 3, '2022-07-15'),
('Igor', 'Šarić', 'Agent', 'igor.saric@mail.com', '0914444000', NULL, 4, '2021-06-06'),
('Petra', 'Klarić', 'Administrativni radnik', 'petra.klaric@mail.com', '0915555000', '0916666000', 1, '2023-03-25'),
('Hrvoje', 'Perić', 'Mehaničar', 'hrvoje.peric@mail.com', '0916666000', NULL, 5, '2021-04-04'),
('Ines', 'Miletić', 'Menadžer', 'ines.miletic@mail.com', '0917777000', '0918888000', 8, '2022-10-01'),
('Stjepan', 'Jakšić', 'Agent', 'stjepan.jaksic@mail.com', '0918888000', NULL, 6, '2021-02-05'),
('Nika', 'Klarić', 'Administrativni radnik', 'nika.klaric@mail.com', '0919999000', '0910000111', 3, '2020-12-20'),
('Domagoj', 'Barišić', 'Agent', 'domagoj.barisic@mail.com', '0910000111', NULL, 1, '2023-05-05'),
('Lea', 'Vidić', 'Mehaničar', 'lea.vidic@mail.com', '0910000222', '0910000333', 2, '2022-01-18'),
('Mislav', 'Lovrić', 'Administrativni radnik', 'mislav.lovric@mail.com', '0910000333', NULL, 4, '2021-04-25');
...
INSERT INTO Rezervacija (ID_kupca, ID_vozila, ID_zaposlenika, ID_osiguranja, Datum_početka, Datum_završetka, Ukupna_cijena, Status_rezervacije)
VALUES 
(1, 1, 1, 1, '2023-05-01', '2023-05-10', 450.00, 'Završena'),
(2, 2, 1, 2, '2023-06-15', '2023-06-18', 120.00, 'Aktivna'),
(3, 3, 1, 3, '2023-07-01', '2023-07-05', 175.00, 'Otkazana'),
(4, 4, 2, 4, '2023-04-10', '2023-04-17', 840.00, 'Završena'),
(5, 5, 2, 5, '2023-03-21', '2023-03-28', 210.00, 'Aktivna'),
(6, 6, 2, 6, '2023-06-11', '2023-06-13', 74.00, 'Završena'),
(7, 7, 2, 7, '2023-02-01', '2023-02-07', 196.00, 'Otkazana'),
(8, 8, 2, 8, '2023-08-05', '2023-08-10', 300.00, 'Završena'),
(9, 9, 2, 9, '2023-04-22', '2023-04-29', 700.00, 'Aktivna'),
(10, 10, 3, 10, '2023-05-13', '2023-05-17', 340.00, 'Aktivna'),
(11, 11, 3, 11, '2023-07-08', '2023-07-12', 225.00, 'Otkazana'),
(12, 12, 3, 12, '2023-03-30', '2023-04-03', 180.00, 'Završena'),
(13, 13, 3, 13, '2023-05-05', '2023-05-10', 450.00, 'Završena'),
(14, 14, 3, 14, '2023-06-10', '2023-06-15', 375.00, 'Aktivna'),
(15, 15, 3, 15, '2023-08-01', '2023-08-05', 175.00, 'Završena'),
(16, 16, 3, 16, '2023-04-15', '2023-04-20', 330.00, 'Aktivna'),
(17, 17, 4, 17, '2023-07-18', '2023-07-22', 235.00, 'Aktivna'),
(18, 18, 4, 18, '2023-03-10', '2023-03-15', 300.00, 'Završena'),
(19, 19, 4, 19, '2023-02-22', '2023-02-25', 90.00, 'Aktivna'),
(20, 20, 4, 20, '2023-04-05', '2023-04-12', 560.00, 'Završena'),
(21, 21, 5, 21, '2023-01-18', '2023-01-22', 600.00, 'Završena'),
(22, 22, 5, 22, '2023-08-15', '2023-08-20', 500.00, 'Aktivna'),
(23, 23, 5, 23, '2023-06-05', '2023-06-10', 325.00, 'Otkazana'),
(24, 24, 5, 24, '2023-05-20', '2023-05-27', 875.00, 'Završena'),
(25, 25, 5, 25, '2023-03-25', '2023-03-30', 660.00, 'Aktivna'),
(26, 26, 5, 26, '2023-02-10', '2023-02-13', 160.00, 'Završena'),
(27, 27, 5, 27, '2023-04-30', '2023-05-05', 275.00, 'Aktivna'),
(28, 28, 5, 28, '2023-07-20', '2023-07-25', 375.00, 'Aktivna'),
(29, 29, 5, 29, '2023-06-15', '2023-06-18', 360.00, 'Završena'),
(30, 30, 5, 30, '2023-08-21', '2023-08-30', 900.00, 'Aktivna');

INSERT INTO Rezervacija_Dodatna_usluga (ID_rezervacije, ID_usluge)
VALUES
(1, 1), (1, 2), (1, 3),
(2, 4), (2, 5),
(3, 6), (3, 7),
...
-- 1. View za prikaz vozila s njihovim prosječnim ocjenama
CREATE VIEW vw_vehicle_average_rating AS
SELECT
    v.ID_vozila,
    v.Marka,
    v.Model,
...
FROM Vozilo v
LEFT JOIN Recenzije_kupaca r ON v.ID_vozila = r.ID_vozila
GROUP BY v.ID_vozila, v.Marka, v.Model;

SELECT * FROM vw_vehicle_average_rating;

-- 2. View za ukupni potrošeni iznos
CREATE VIEW vw_customer_total_spent AS
SELECT
    k.ID_kupca,
    k.Ime,
    k.Prezime,
    SUM(r.Ukupna_cijena) AS Ukupno_potrošeno
FROM Kupac k
LEFT JOIN Rezervacija r ON k.ID_kupca = r.ID_kupca
GROUP BY k.ID_kupca, k.Ime, k.Prezime;

SELECT * FROM vw_customer_total_spent;


-- 3. View za prikaz vozila s ukupnim prihodom
CREATE VIEW vw_vehicle_revenue AS
SELECT
    v.ID_vozila,
    v.Marka,
    v.Model,
    SUM(r.Ukupna_cijena) AS Ukupni_prihod
FROM Vozilo v
LEFT JOIN Rezervacija r ON v.ID_vozila = r.ID_vozila
GROUP BY v.ID_vozila, v.Marka, v.Model;

SELECT * FROM vw_vehicle_revenue;

-- 4. View za prikaz aktivnih rezervacija s pojedinostima o kupcima i vozilima
...
SELECT
    ...
    r.Ukupna_cijena
FROM Rezervacija r
INNER JOIN Kupac k ON r.ID_kupca = k.ID_kupca
INNER JOIN Vozilo v ON r.ID_vozila = v.ID_vozila
WHERE r.Status_rezervacije = 'Aktivna';

SELECT * FROM vw_active_reservations;

-- 5. View za prikaz povijesti održavanja svakog vozila
CREATE VIEW vw_vehicle_maintenance_history AS
SELECT
    v.ID_vozila,
    v.Marka,
    v.Model,
    ...
    o.Cijena_servisa
FROM Vozilo v
INNER JOIN Održavanje_vozila o ON v.ID_vozila = o.ID_vozila
ORDER BY v.ID_vozila, o.Datum_servisa DESC;

SELECT * FROM vw_vehicle_maintenance_history;
...
CREATE TRIGGER trg_before_reservation_insert_check_availability
BEFORE INSERT ON Rezervacija
FOR EACH ROW
BEGIN
    ...
    FROM Rezervacija
    WHERE ID_vozila = NEW.ID_vozila
      AND Status_rezervacije = 'Aktivna'
      AND (
            (NEW.Datum_početka BETWEEN Datum_početka AND Datum_završetka)
            OR
            (NEW.Datum_završetka BETWEEN Datum_početka AND Datum_završetka)
            OR
            (Datum_početka BETWEEN NEW.Datum_početka AND NEW.Datum_završetka)
        );

    IF overlapping_count > 0 THEN
        SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Vozilo nije dostupno u odabranom periodu.';
    END IF;
END;
//
...
-- 7. Okidač za ažuriranje statusa vozila na 'Servisirano' nakon što se zabilježi održavanje

DELIMITER //

CREATE TRIGGER trg_after_maintenance_insert_update_vehicle_status
AFTER INSERT ON Održavanje_vozila
FOR EACH ROW
BEGIN
    UPDATE Vozilo
...
CREATE PROCEDURE GetVehiclesDueForMaintenance(IN months INT)
BEGIN
    SELECT v.ID_vozila, v.Marka, v.Model, MAX(o.Datum_servisa) AS LastServiceDate
    FROM Vozilo v
    LEFT JOIN Održavanje_vozila o ON v.ID_vozila = o.ID_vozila
    GROUP BY v.ID_vozila, v.Marka, v.Model
    HAVING DATEDIFF(CURRENT_DATE, COALESCE(MAX(o.Datum_servisa), '1900-01-01')) > (months * 30);
END;
//
...
CREATE PROCEDURE GetVehicleTotalRevenue(IN vehicle_id INT)
BEGIN
    SELECT v.ID_vozila, v.Marka, v.Model, SUM(r.Ukupna_cijena) AS TotalRevenue
    FROM Vozilo v
    INNER JOIN Rezervacija r ON v.ID_vozila = r.ID_vozila
    WHERE v.ID_vozila = vehicle_id
    GROUP BY v.ID_vozila, v.Marka, v.Model;
END;
//
...
BEGIN
    ...
    INSERT INTO Plaćanje (ID_placanje, Iznos, Datum_plaćanja, Način_plaćanja, Status_plaćanja)
